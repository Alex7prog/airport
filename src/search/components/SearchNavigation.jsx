...
const SearchNavigation = () => {
  ...
  return (
    <div className="search-result__nav">
      <div
        className={
          pathname === '/departures' ? 'search-result__nav__departures nav_active' : 'search-result__nav__departures'
        }
      >
        {/* <a href="#"> */}
        ...
        <Link to={`/departures${useLocation().search}`}>DEPARTURES</Link>
        {/* </a> */}
      </div>
      <div
        className={
          pathname === '/arrivals' ? 'search-result__nav__arrivals nav_active' : 'search-result__nav__arrivals'
        }
      >
        {/* <a href="#"> */}
        <span data-v-7746f986="" className="icon">
          ...
          {/* <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g data-v-7746f986="" id="Page-1" stroke="none" stroke-width="1" fill="#FFFFFF" fillRule="nonzero">
              <g
                data-v-7746f986=""
                id="Group"
        ...
        <Link to={`/arrivals${useLocation().search}`}>ARRIVALS</Link>
        {/* </a> */}
      </div>
    </div>
  );
